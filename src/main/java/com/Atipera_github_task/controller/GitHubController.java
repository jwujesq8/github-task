...
public class GitHubController {
    ...
    public ResponseEntity<Uni<List<ReposInfoResponseDto>>> getRepositories(@PathVariable String username) {
        return ResponseEntity.ok(gitHubService.listNonForkReposByUsername(username));
    }
}
